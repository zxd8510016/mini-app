var local_database = [
  {
    ...
    music: {
      ...
      title: "亡灵序曲完美钢琴版",
      coverImg: "http://p1.music.126.net/DsTgTai5LwLu89v64XARzA==/109951162922613259.jpg?param=130y130"
    }
  },
  {
    title: "比利·林恩的中场故事",
    ...
    postId: 1,
    music: {
      url: "http://music.163.com/song/media/outer/url?id=1339122905",
      title: "千年",
      coverImg: "http://p1.music.126.net/r9qhbEBZw8oNTVsD5yaPlA==/109951163788842741.jpg?param=130y130"
    }
  },
  {
    ...
    postId: 2,
    music: {
      url: "http://music.163.com/song/media/outer/url?id=1398823605.mp3",
      title: "贝多芬的悲伤",
      coverImg: "http://p2.music.126.net/-H8v3QjUR_y8rraDMinPTQ==/109951164445781358.jpg?param=130y130"
    }
  },
  {
    ...
    music: {
      ...
      title: "演员",
      coverImg: "http://p1.music.126.net/qpvBqYIqkRhO9Ry2qOCdJQ==/2942293117852634.jpg?param=130y130"
    }
  },
  {
    ...
    music: {
      ...
      title: "有何不可",
      coverImg: "http://p1.music.126.net/Md3RLH0fe2a_3dMDnfqoQg==/18590542604286213.jpg?param=130y130"
    }
  },
  {
